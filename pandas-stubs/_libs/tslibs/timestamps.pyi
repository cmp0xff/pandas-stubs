...
class Timestamp(datetime, SupportsIndex):
    ...
    def __le__(self, other: datetime | np.datetime64 | Self) -> bool: ...  # type: ignore[overload-overlap] # pyright: ignore[reportOverlappingOverload]
    @overload
    def __le__(self, other: _date) -> Never: ...
    @overload
    ...
    @overload  # type: ignore[override]
    def __lt__(self, other: datetime | np.datetime64 | Self) -> bool: ...  # type: ignore[overload-overlap] # pyright: ignore[reportOverlappingOverload]
    @overload
    def __lt__(self, other: _date) -> Never: ...
    @overload
    ...
    @overload  # type: ignore[override]
    def __ge__(self, other: datetime | np.datetime64 | Self) -> bool: ...  # type: ignore[overload-overlap] # pyright: ignore[reportOverlappingOverload]
    @overload
    def __ge__(self, other: _date) -> Never: ...
    @overload
    ...
    @overload  # type: ignore[override]
    def __gt__(self, other: datetime | np.datetime64 | Self) -> bool: ...  # type: ignore[overload-overlap] # pyright: ignore[reportOverlappingOverload]
    @overload
    def __gt__(self, other: _date) -> Never: ...
    @overload
