...
def test_fy5253_python_scalars(left: FY5253) -> None:
...
def test_fy5253_numpy_scalars(left: FY5253) -> None:
...
def test_fy5253_pandas_scalars(left: FY5253) -> None:
...
def test_fy5253_numpy_arrays(left: FY5253) -> None:
