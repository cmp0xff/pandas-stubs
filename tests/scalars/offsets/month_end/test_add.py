...
def test_monthend_python_scalars(left: MonthEnd) -> None:
...
def test_monthend_numpy_scalars(left: MonthEnd) -> None:
...
def test_monthend_pandas_scalars(left: MonthEnd) -> None:
...
def test_monthend_numpy_arrays(left: MonthEnd) -> None:
