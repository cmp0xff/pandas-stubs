...
def test_businessmonthend_python_scalars(left: BusinessMonthEnd) -> None:
    """BusinessMonthEnd handles python scalars in both directions."""
...
def test_businessmonthend_numpy_scalars(left: BusinessMonthEnd) -> None:
    """BusinessMonthEnd handles numpy scalars in both directions."""
...
def test_businessmonthend_pandas_scalars(left: BusinessMonthEnd) -> None:
    """BusinessMonthEnd handles pandas scalars in both directions."""
...
def test_businessmonthend_numpy_arrays(left: BusinessMonthEnd) -> None:
    """BusinessMonthEnd supports object arrays, including empty arrays."""
