...
def test_dateoffset_python_scalars(left: DateOffset) -> None:
...
def test_dateoffset_numpy_scalars(left: DateOffset) -> None:
...
def test_dateoffset_pandas_scalars(left: DateOffset) -> None:
...
def test_dateoffset_numpy_arrays(left: DateOffset) -> None:
