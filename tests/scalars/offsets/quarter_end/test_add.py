...
def test_quarterend_python_scalars(left: QuarterEnd) -> None:
...
def test_quarterend_numpy_scalars(left: QuarterEnd) -> None:
...
def test_quarterend_pandas_scalars(left: QuarterEnd) -> None:
...
def test_quarterend_numpy_arrays(left: QuarterEnd) -> None:
