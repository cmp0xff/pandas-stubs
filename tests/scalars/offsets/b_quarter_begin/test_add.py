...
def test_bquarterbegin_python_scalars(left: BQuarterBegin) -> None:
    """BQuarterBegin handles python scalars in both directions."""
...
def test_bquarterbegin_numpy_scalars(left: BQuarterBegin) -> None:
    """BQuarterBegin handles numpy scalars in both directions."""
...
def test_bquarterbegin_pandas_scalars(left: BQuarterBegin) -> None:
    """BQuarterBegin handles pandas scalars in both directions."""
...
def test_bquarterbegin_numpy_arrays(left: BQuarterBegin) -> None:
    """BQuarterBegin supports object arrays, including empty arrays."""
