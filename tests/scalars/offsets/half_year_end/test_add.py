...
@pytest.fixture
def left() -> HalfYearEnd:
    """Left operand."""
    return HalfYearEnd()


def test_halfyearend_python_scalars(left: HalfYearEnd) -> None:
...
def test_halfyearend_numpy_scalars(left: HalfYearEnd) -> None:
...
def test_halfyearend_pandas_scalars(left: HalfYearEnd) -> None:
...
def test_pandas_scalar_regression(left: HalfYearEnd) -> None:
...
def test_halfyearend_numpy_arrays(left: HalfYearEnd) -> None:
