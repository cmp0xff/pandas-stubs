...
@pytest.fixture
def left() -> BusinessHour:
    """Left operand."""
    return BusinessHour()


def test_businesshour_python_scalars(left: BusinessHour) -> None:
...
def test_businesshour_numpy_scalars(left: BusinessHour) -> None:
...
def test_businesshour_pandas_scalars(left: BusinessHour) -> None:
...
def test_businesshour_numpy_arrays(left: BusinessHour) -> None:
