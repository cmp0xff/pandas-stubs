...
def test_byearend_python_scalars(left: BYearEnd) -> None:
    """BYearEnd handles python scalars in both directions."""
...
def test_byearend_numpy_scalars(left: BYearEnd) -> None:
    """BYearEnd handles numpy scalars in both directions."""
...
def test_byearend_pandas_scalars(left: BYearEnd) -> None:
    """BYearEnd handles pandas scalars in both directions."""
...
def test_byearend_numpy_arrays(left: BYearEnd) -> None:
    """BYearEnd supports object arrays, including empty arrays."""
