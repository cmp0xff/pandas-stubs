...
def test_quarterbegin_python_scalars(left: QuarterBegin) -> None:
    """QuarterBegin handles python scalars in both directions."""
...
def test_quarterbegin_numpy_scalars(left: QuarterBegin) -> None:
    """QuarterBegin handles numpy scalars in both directions."""
...
def test_quarterbegin_pandas_scalars(left: QuarterBegin) -> None:
    """QuarterBegin handles pandas scalars in both directions."""
...
def test_quarterbegin_numpy_arrays(left: QuarterBegin) -> None:
    """QuarterBegin supports object arrays, including empty arrays."""
