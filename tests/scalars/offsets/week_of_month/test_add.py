...
@pytest.fixture
def left() -> WeekOfMonth:
    """Left operand."""
    return WeekOfMonth()


def test_weekofmonth_python_scalars(left: WeekOfMonth) -> None:
...
def test_weekofmonth_numpy_scalars(left: WeekOfMonth) -> None:
...
def test_weekofmonth_pandas_scalars(left: WeekOfMonth) -> None:
...
def test_weekofmonth_numpy_arrays(left: WeekOfMonth) -> None:
