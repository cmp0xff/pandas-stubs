...
def test_bhalfyearend_python_scalars(left: BHalfYearEnd) -> None:
    """BHalfYearEnd handles python scalars in both directions."""
...
def test_bhalfyearend_numpy_scalars(left: BHalfYearEnd) -> None:
    """BHalfYearEnd handles numpy scalars in both directions."""
...
def test_bhalfyearend_pandas_scalars(left: BHalfYearEnd) -> None:
    """BHalfYearEnd handles pandas scalars in both directions."""
...
def test_bhalfyearend_numpy_arrays(left: BHalfYearEnd) -> None:
    """BHalfYearEnd supports object arrays, including empty arrays."""
