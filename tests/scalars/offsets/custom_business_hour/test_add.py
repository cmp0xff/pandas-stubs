...
def test_custombusinesshour_python_scalars(left: CustomBusinessHour) -> None:
    """CustomBusinessHour handles python scalars in both directions."""
...
def test_custombusinesshour_numpy_scalars(left: CustomBusinessHour) -> None:
    """CustomBusinessHour handles numpy scalars in both directions."""
...
def test_custombusinesshour_pandas_scalars(left: CustomBusinessHour) -> None:
    """CustomBusinessHour handles pandas scalars in both directions."""
...
def test_custombusinesshour_numpy_arrays(left: CustomBusinessHour) -> None:
    """CustomBusinessHour supports object arrays, including empty arrays."""
