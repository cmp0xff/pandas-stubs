...
@pytest.fixture
def left() -> SemiMonthEnd:
    """Left operand."""
    return SemiMonthEnd()


def test_semimonthend_python_scalars(left: SemiMonthEnd) -> None:
...
def test_semimonthend_numpy_scalars(left: SemiMonthEnd) -> None:
...
def test_semimonthend_pandas_scalars(left: SemiMonthEnd) -> None:
...
def test_semimonthend_numpy_arrays(left: SemiMonthEnd) -> None:
