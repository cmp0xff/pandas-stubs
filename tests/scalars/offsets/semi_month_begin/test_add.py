...
def test_semimonthbegin_python_scalars(left: SemiMonthBegin) -> None:
    """SemiMonthBegin handles python scalars in both directions."""
...
def test_semimonthbegin_numpy_scalars(left: SemiMonthBegin) -> None:
    """SemiMonthBegin handles numpy scalars in both directions."""
...
def test_semimonthbegin_pandas_scalars(left: SemiMonthBegin) -> None:
    """SemiMonthBegin handles pandas scalars in both directions."""
...
def test_semimonthbegin_numpy_arrays(left: SemiMonthBegin) -> None:
    """SemiMonthBegin supports object arrays, including empty arrays."""
