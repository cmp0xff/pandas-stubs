...
def test_lastweekofmonth_python_scalars(left: LastWeekOfMonth) -> None:
    """LastWeekOfMonth handles python scalars in both directions."""
...
def test_lastweekofmonth_numpy_scalars(left: LastWeekOfMonth) -> None:
    """LastWeekOfMonth handles numpy scalars in both directions."""
...
def test_lastweekofmonth_pandas_scalars(left: LastWeekOfMonth) -> None:
    """LastWeekOfMonth handles pandas scalars in both directions."""
...
def test_lastweekofmonth_numpy_arrays(left: LastWeekOfMonth) -> None:
    """LastWeekOfMonth supports object arrays, including empty arrays."""
