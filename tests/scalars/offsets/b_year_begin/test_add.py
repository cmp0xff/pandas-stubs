...
def test_byearbegin_python_scalars(left: BYearBegin) -> None:
    """BYearBegin handles python scalars in both directions."""
...
def test_byearbegin_numpy_scalars(left: BYearBegin) -> None:
    """BYearBegin handles numpy scalars in both directions."""
...
def test_byearbegin_pandas_scalars(left: BYearBegin) -> None:
    """BYearBegin handles pandas scalars in both directions."""
...
def test_byearbegin_numpy_arrays(left: BYearBegin) -> None:
    """BYearBegin supports object arrays, including empty arrays."""
