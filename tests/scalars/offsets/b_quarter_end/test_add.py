...
def test_bquarterend_python_scalars(left: BQuarterEnd) -> None:
    """BQuarterEnd handles python scalars in both directions."""
...
def test_bquarterend_numpy_scalars(left: BQuarterEnd) -> None:
    """BQuarterEnd handles numpy scalars in both directions."""
...
def test_bquarterend_pandas_scalars(left: BQuarterEnd) -> None:
    """BQuarterEnd handles pandas scalars in both directions."""
...
def test_bquarterend_numpy_arrays(left: BQuarterEnd) -> None:
    """BQuarterEnd supports object arrays, including empty arrays."""
