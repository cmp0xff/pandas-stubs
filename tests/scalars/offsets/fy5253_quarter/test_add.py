...
@pytest.fixture
def left() -> FY5253Quarter:
    """Left operand."""
    return FY5253Quarter()


def test_fy5253quarter_python_scalars(left: FY5253Quarter) -> None:
...
def test_fy5253quarter_numpy_scalars(left: FY5253Quarter) -> None:
...
def test_fy5253quarter_numpy_arrays(left: FY5253Quarter) -> None:
