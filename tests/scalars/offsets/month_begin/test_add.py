...
def test_monthbegin_python_scalars(left: MonthBegin) -> None:
    """MonthBegin handles python scalars in both directions."""
...
def test_monthbegin_numpy_scalars(left: MonthBegin) -> None:
    """MonthBegin handles numpy scalars in both directions."""
...
def test_monthbegin_pandas_scalars(left: MonthBegin) -> None:
    """MonthBegin handles pandas scalars in both directions."""
...
def test_monthbegin_numpy_arrays(left: MonthBegin) -> None:
    """MonthBegin supports object arrays, including empty arrays."""
