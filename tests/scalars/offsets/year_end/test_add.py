...
def test_yearend_python_scalars(left: YearEnd) -> None:
...
def test_yearend_numpy_scalars(left: YearEnd) -> None:
...
def test_yearend_pandas_scalars(left: YearEnd) -> None:
...
def test_yearend_numpy_arrays(left: YearEnd) -> None:
