...
def test_halfyearbegin_python_scalars(left: HalfYearBegin) -> None:
    """HalfYearBegin handles python scalars in both directions."""
...
def test_halfyearbegin_numpy_scalars(left: HalfYearBegin) -> None:
    """HalfYearBegin handles numpy scalars in both directions."""
...
def test_halfyearbegin_pandas_scalars(left: HalfYearBegin) -> None:
    """HalfYearBegin handles pandas scalars in both directions."""
...
def test_halfyearbegin_numpy_arrays(left: HalfYearBegin) -> None:
    """HalfYearBegin supports object arrays, including empty arrays."""
