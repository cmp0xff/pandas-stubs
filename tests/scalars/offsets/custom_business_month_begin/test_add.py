...
def test_custombusinessmonthbegin_python_scalars(
    left: CustomBusinessMonthBegin,
) -> None:
    """CustomBusinessMonthBegin handles python scalars in both directions."""
...
def test_custombusinessmonthbegin_numpy_scalars(left: CustomBusinessMonthBegin) -> None:
    """CustomBusinessMonthBegin handles numpy scalars in both directions."""
...
def test_custombusinessmonthbegin_pandas_scalars(
    left: CustomBusinessMonthBegin,
) -> None:
    """CustomBusinessMonthBegin handles pandas scalars in both directions."""
...
def test_custombusinessmonthbegin_numpy_arrays(left: CustomBusinessMonthBegin) -> None:
    """CustomBusinessMonthBegin supports object arrays, including empty arrays."""
