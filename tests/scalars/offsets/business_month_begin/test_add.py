...
def test_businessmonthbegin_python_scalars(left: BusinessMonthBegin) -> None:
    """BusinessMonthBegin handles python scalars in both directions."""
...
def test_businessmonthbegin_numpy_scalars(left: BusinessMonthBegin) -> None:
    """BusinessMonthBegin handles numpy scalars in both directions."""
...
def test_businessmonthbegin_pandas_scalars(left: BusinessMonthBegin) -> None:
    """BusinessMonthBegin handles pandas scalars in both directions."""
...
def test_businessmonthbegin_numpy_arrays(left: BusinessMonthBegin) -> None:
    """BusinessMonthBegin supports object arrays, including empty arrays."""
